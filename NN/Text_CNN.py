...
from keras.layers import Bidirectional, GlobalMaxPool1D, concatenate, Flatten, PReLU, BatchNormalization, Conv2D, Reshape
from keras.layers import MaxPool2D, Concatenate, Conv1D, MaxPool1D
...
conv_0 = Conv1D(num_filters, kernel_size=filter_sizes[0], kernel_initializer='normal', activation='elu')(x)
conv_1 = Conv1D(num_filters, kernel_size=filter_sizes[1], kernel_initializer='normal', activation='elu')(x)
conv_2 = Conv1D(num_filters, kernel_size=filter_sizes[2], kernel_initializer='normal', activation='elu')(x)
conv_3 = Conv1D(num_filters, kernel_size=filter_sizes[3], kernel_initializer='normal', activation='elu')(x)
